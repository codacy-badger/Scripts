...
AK3_DIR=$KERNEL_DIR/../AK3/AK3-whyred
CODENAME="Whyred"
CONFIG_OLD=mystic-whyred-oldcam_defconfig
CONFIG_NEW=mystic-whyred-newcam_defconfig
...
while true; do
    ...
    echo -e " Menu                                                               "
    echo -e " ╔═════════════════════════════════════════════════════════════════╗"
    echo -e " ║ 1. Export Whyred OldCam defconfig to Out Dir                    ║"
    echo -e " ║ 2. Export Whyred NewCam defconfig to Out Dir                    ║"
